...
document.getElementById("navMenu").innerHTML =
        '<ul class="styleguide-navigation">'+
            ...
            '<li class="framwork-components"><ul>Framework Components'+
                ...
                '<li class=""><a href="./inprogress.html">Project Cycle</a></li>'+
            ...
            '<li class="framwork-components"><ul>Form Controls'+
                ...
                '<li class=""><a href="./inprogress.html">Links (Actionable links)</a></li>'+
            ...
            '<li class="framwork-components"><ul>Data Pattern'+
                ...
                '<li class=""><a href="./inprogress.html">List style for cards</a></li>'+
            ...
            //     '<li class=""><a href="./inprogress.html">Advanced Search</a></li>'+
            //     '</ul>'+
            // '</li>'+
        '</ul>';